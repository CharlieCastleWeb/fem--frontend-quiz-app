            ...
            return (
              <div key={radioButtonId}>
                ...
                <label
                  ...
                  className={`peer-focus-visible:outline-3 peer-focus-visible:outline-offset-4 peer-focus-visible:outline-fem-purple-600 peer-disabled:pointer-events-none peer-disabled:cursor-not-allowed cursor-pointer p-3.25 lg:p-5.25 bg-fem-white dark:bg-fem-blue-850 w-full flex items-center  justify-items-start gap-4 md:gap-8 rounded-xl md:rounded-3xl border-3 transition-all duration-300 ease-in-out ${borderClass}`}
